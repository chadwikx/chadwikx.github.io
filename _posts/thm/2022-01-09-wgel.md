...
<center>![nmap]({{ site.baseurl }}/assets/wgel/1.png)</center>
...
<center>![gobuster]({{ site.baseurl }}/assets/wgel/2.png)</center>
 
Immediately - the `.ssh` directory stands out to me. I took a look inside and sure enough - a possible SSH key file?!

<center>![sneakyssh]({{ site.baseurl }}/assets/wgel/3.png)</center>
